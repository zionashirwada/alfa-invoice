...
function generateInvoice() {
  ...
  let invoiceHTML = `
  <meta charset="UTF-8">
  <title>ACQ/${lastTwoDigitsOfYear}/${invoiceNumber} </title>
  <link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/css/bootstrap.min.css'><link rel="stylesheet" href="quotation.css">
...
<div class="container">
  <div class="invoice">
    ...
    <div class="row">
      ...
      <div class="col-10">
        <p class="text-left" style="font-size:20px;"><strong>Quotation </strong><span style="color: rgb(0, 98, 255);">ACQ/${lastTwoDigitsOfYear}/${invoiceNumber}</span></p>
        <div style="padding-left:8px;">
        <p style="font-size:13px;">
        <strong>Quotation Date </strong> : ${currentDate} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  // Loop through each item and add it to the Quotation HTML
